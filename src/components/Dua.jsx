...
const Dua = () => {
  ...
  return (
    <div
      className="bg-gradient-to-r from-plum to-plum/20 rounded-3xl shadow-xl hover:shadow-2xl hover:scale-102 transition-all duration-300 ease-out p-4 sm:p-5 md:p-6 lg:p-7 xl:p-8 2xl:p-10 w-full h-full flex flex-col cursor-pointer relative overflow-hidden"
      ...
      <div className="flex flex-col h-full justify-between relative z-10">
        ...
        <div className="flex justify-between items-start flex-shrink-0">
          ...
          <div className="flex items-center space-x-1 sm:space-x-1.5 md:space-x-2 lg:space-x-2.5 xl:space-x-3 flex-shrink-0">
            ...
            <MessageCircle className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 xl:w-7 xl:h-7 2xl:w-8 2xl:h-8 text-white/80 fill-white/20" />
          </div>
        </div>
