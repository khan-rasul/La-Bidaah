...
const Dua = () => {
  ...
  return (
    <div
      className="bg-gradient-to-r from-plum to-plum/20 rounded-3xl shadow-xl hover:shadow-2xl hover:scale-101 transition-all duration-300 ease-out p-4 sm:p-5 md:p-6 lg:p-7 xl:p-8 2xl:p-10 w-full h-full flex flex-col cursor-pointer relative overflow-hidden"
      ...
      <div className="flex flex-col h-full justify-between relative z-10">
        ...
        <div className="flex justify-between items-start flex-shrink-0">
          ...
          <div className="flex items-center space-x-1 sm:space-x-1.5 md:space-x-2 lg:space-x-2.5 xl:space-x-3 flex-shrink-0">
            ...
            <MessageCircle className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 xl:w-7 xl:h-7 2xl:w-8 2xl:h-8 text-white fill-white/20 drop-shadow-md" />
          </div>
        </div>
        ...
        <div className="text-center flex-1 flex flex-col justify-center px-1 sm:px-2 md:px-3 lg:px-4 xl:px-6 2xl:px-8 py-2 sm:py-3 md:py-4 lg:py-5 xl:py-6 2xl:py-8 min-h-0">
          <div className="text-white text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-bold leading-relaxed mb-1 sm:mb-1.5 md:mb-2 lg:mb-3 xl:mb-4 2xl:mb-5 break-words">
            {currentDua.arabic}
          </div>
          <p className="text-white/90 text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl font-medium font-montserrat break-words">
